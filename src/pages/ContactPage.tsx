  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 space-y-10">
      <SeoHead
        ...
        description="Contact Digi Seva Solution Jan Seva Kendra in New Ashok Nagar, East Delhi 110096. Call +91 7900867261, WhatsApp, or visit Block C/203, Masjid Wali Gali for Aadhaar, PAN, Banking, RTO & IT services."
        path="/contact"
      />
      {/* Header Banner */}
