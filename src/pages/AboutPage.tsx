  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 space-y-10">
      <SeoHead
        ...
        description="About Digi Seva Solution - Authorized Common Service Center (Jan Seva Kendra) at Block C/203, Masjid Wali Gali, New Ashok Nagar, Delhi 110096. Providing Aadhaar, PAN card, banking, RTO, and IT software development services."
        path="/about"
      />
      {/* Page Title Header */}
